...
import com.capgemini.electricityBillSystem.service.ReadingService;
...
//        return connectionService.newConnectionRequest(connection);
	...
	@GetMapping("/readMeterReading/{readingId}")
   public ResponseEntity<Reading> readMeterReading(@PathVariable(name = " readingId") int readingId)
